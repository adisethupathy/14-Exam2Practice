...
def run_test_practice_problem2a():
    ...
    expected = [2, 3, 4, 5]
    actual = practice_problem2a(list, 1)
    print()
    print("Expected:", expected)
    print("actual:", actual)

    expected = [3, 4, 5, 6]
    actual = practice_problem2a(list, 2)
    print()
    print("Expected:", expected)
    print("actual:", actual)

    expected = [4, 5, 6, 7]
    actual = practice_problem2a(list, 3)
    print()
    print("Expected:", expected)
    print("actual:", actual)

    expected = [5, 6, 7, 8]
    actual = practice_problem2a(list, 4)
    print()
    print("Expected:", expected)
    print("actual:", actual)
...
def practice_problem2b(sequence):
    ...
    for k in range(len(sequence)):
        if (len(sequence[k]) > 0):
            newletter = sequence[k][0]
            new_string += str(newletter)
    return new_string
